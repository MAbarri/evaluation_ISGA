				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="#">Gestion des types d'utilisateurs</a></li>
						</ul>
					</li>
  					<li class="dropdown">
  						<a href="#" class="dropdown-toggle" data-toggle="dropdown"> Administration</a>
  						<ul class="dropdown-menu">
  							<li><a href="#">Gestion des niveaux</a></li>
  							<li><a href="#">Gestion des filliéres</a></li>
    					...
    					<li class="dropdown">
    						...
    						<ul class="dropdown-menu">
    							<li><a href="#">Gestion des Questions</a></li>
    							<li><a href="#">Gestion des types de Questions</a></li>
                  <li class="divider"></li>
                  <li><a href="#">Gestion des Examens</a></li>
    							<li><a href="#">Gestion des types de Examens</a></li>
    						</ul>
    					</li>
