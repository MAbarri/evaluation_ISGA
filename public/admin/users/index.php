...
require_once '../../../connection.php';
  ...
  try  {
    $sql = "SELECT firstname, lastname, email, typeusers.name FROM users INNER JOIN typeusers ON users.userTypeId = typeusers.id";
          ...
          <div class="row">
            ...
            <table class="col-md-12 table table-hover">
              ...
              <tr>
                ...
                <td>
                <button type="button" class="btn btn-xs btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
